...
export function MaterialSymbolsRemoveRounded(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M6 13q-.425 0-.713-.288Q5 12.425 5 12t.287-.713Q5.575 11 6 11h12q.425 0 .712.287q.288.288.288.713t-.288.712Q18.425 13 18 13Z"
      ></path>
    </svg>
  )
}
...
export function ClarityBackupLine(props: SVGProps<SVGSVGElement>) {
  return (
...
export function ClarityBackupRestoreLine(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 36 36" {...props}>
      <path
        fill="currentColor"
